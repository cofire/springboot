...
import com.cf.dao.model.system.RoleResource;
import com.cf.dao.model.system.RoleResourceExample;
...
public interface RoleResourceMapper {
    ...
    int deleteByPrimaryKey(@Param("roleId") String roleId, @Param("resId") String resId);
    ...
    RoleResource selectByPrimaryKey(@Param("roleId") String roleId, @Param("resId") String resId);
